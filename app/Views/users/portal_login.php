    ...
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-5">
            ...
            <div class="card login-card p-4 p-md-5">
                ...
                <form action="<?= base_url('r/auth') ?>" method="POST">
                    <?= csrf_field() ?>
            ...
            <div class="text-center mt-4">
                <a href="<?= base_url('/r/household-register') ?>" class="small link-warm text-decoration-none fw-bold">← هل تريد تسجيل عائلة جديدة؟</a>
            </div>
